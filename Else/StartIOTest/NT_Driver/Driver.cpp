    ...
    )
{
	...
	{
		// 
		// TODO(H): Cancel Routine 先获取 CancelSpinLock ，那么这个 IRP 交给 Cancle Routine
		//			处理
		//
	...
	{
		// 
		// TODO(H): StartIO Routine 先获取 CancelSpinLock ， 不管此刻该 IRP 有没有别 Cancel ，
		//			Cancel Routine 肯定没有运行，这里直接将该 IRP 的 Cancel Routine 设置为 NULL
		//
		//			有一个疑问，在这个时刻，IRP 有没有被 Cancel 的可能性呢？
		//
    ...
    )
{
	...
	{
		// 
		// TODO(H): Cancel Routine 先获取 CancleSpinLock , 这个 IRP 当然由 Cancle 
		// 			Routine 处理
		//
		...
		// 
		// TODO(H): 从这里来看，StartIO Routine 也是有可能运行在 Cancel Routine 
		// 			的上下文的
		//			怪不着，这玩意理解起来这么别扭
	...
	{
		// 
		// TODO(H): 不存在竞争关系，但把这个 IRP 从队列中 remove 的任务交了 Cancel Routine 
		//
		// 			越来越觉的，StartIo 的封装真是相当的渣，或者说，它的核心处理逻辑本身就
		//			非常别扭		
		//
